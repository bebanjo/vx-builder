...
# after script
test -f $HOME/.casher/bin/casher && /opt/rbenv/versions/1.9.3-p547/bin/ruby $HOME/.casher/bin/casher push http://localhost:3001/test/pull-request/rvm-2.0.0-gemfile.tgz
