...
test -f $HOME/.casher/bin/casher && /opt/rbenv/versions/1.9.3-p547/bin/ruby $HOME/.casher/bin/casher fetch http://localhost:3001/test/pull-request/rvm-1.9.3-gemfile.tgz http://localhost:3001/master/rvm-1.9.3-gemfile.tgz || true
